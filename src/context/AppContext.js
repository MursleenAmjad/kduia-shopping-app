...
export const AppReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "DELETE_ITEM":
      new_expenses = state.expenses.filter(
...
const initialState = {
  expenses: [
    { id: "Marketing", name: "Marketing", allocatedBudget: 100 },
    { id: "Finance", name: "Finance", allocatedBudget: 100 },
    { id: "Sales", name: "Sales", allocatedBudget: 100 },
  ],
  Location: "£",
  Budget: 0,
};
